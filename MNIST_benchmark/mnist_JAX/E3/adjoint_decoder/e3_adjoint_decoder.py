...
plt.ylabel('Fidelity')
plt.savefig(
    f'e3_adjoint_{num_trash_bits}_{num_data_bits}_{num_entangler_bits}_{num_layers}_trash_fidelity_training.png')
plt.show()
...
plt.ylabel('Fidelity')
plt.savefig(f'e3_adjoint_{num_trash_bits}_{num_data_bits}_{num_entangler_bits}_{num_layers}_trash_fidelity.png')
plt.show()
print("*" * 50)
...
plt.legend(["Train 0", "Train 1", "Test 0", "Test 1"], loc=3)
plt.ylabel('Fidelity')
plt.savefig(f'e3_adjoint_{num_trash_bits}_{num_data_bits}_{num_entangler_bits}_{num_layers}_final_fidelity.png')
plt.show()
"""
